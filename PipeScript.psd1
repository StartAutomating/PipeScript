@{
    ...
    FunctionsToExport = 'Export-Pipescript','Get-PipeScript','Get-Transpiler','Import-PipeScript','Invoke-PipeScript','Join-PipeScript','New-PipeScript','Search-PipeScript','Update-PipeScript','Use-PipeScript','PipeScript.Optimizer.ConsolidateAspects','Automatic.Variable.MyCallstack','Automatic.Variable.MySelf','Automatic.Variable.MyParameters','Automatic.Variable.MyCaller','PipeScript.PostProcess.InitializeAutomaticVariables'
    PrivateData = @{
        FileTypes = @{
            Transpiler = @{
                Pattern = '\.psx\.ps1$'
