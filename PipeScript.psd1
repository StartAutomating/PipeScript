@{
    ...
    FunctionsToExport = 'Language.Dart','Template.HelloWorld.dart','Language.Batch','Template.Batch.Wrapper','Language.CSharp','Template.Class.cs','Template.HelloWorld.cs','Template.Method.cs','Template.Namespace.cs','Template.Property.cs','Template.TryCatch.cs','Language.Go','Template.HelloWorld.go','Language.Ruby','Template.HelloWorld.rb','Language.Razor','Language.Bash','Template.Bash.Wrapper','Language.Conf','Language.Docker','Template.Docker.InstallModule','Template.Docker.InstallPackage','Template.Docker.LabelModule','Template.Docker.Add','Template.Docker.Argument','Template.Docker.Command','Template.Docker.CopyItem','Template.Docker.EntryPoint','Template.Docker.Expose','Template.Docker.From','Template.Docker.HealthCheck','Template.Docker.Label','Template.Docker.OnBuild','Template.Docker.Run','Template.Docker.SetLocation','Template.Docker.SetShell','Template.Docker.SetUser','Template.Docker.SetVariable','Template.Docker.StopSignal','Template.Docker.Volume','Language.ATOM','Language.JavaScript','Template.HelloWorld.js','Template.Assignment.js','Template.Class.js','Template.DoLoop.js','Template.ForeachArgument.js','Template.ForEachLoop.js','Template.ForLoop.js','Template.Function.js','Template.InvokeMethod.js','Template.RegexLiteral.js','Template.TryCatch.js','Template.WhileLoop.js','Language.Perl','Language.Cuda','Language.Bicep','Language.LaTeX','Language.XAML','Language.XML','Language.YAML','Language.HLSL','Language.CPlusPlus','Template.HelloWorld.cpp','Template.Include.cpp','Language.Kotlin','Language.JSON','Language.TCL','Language.HTML','Template.HTML.CustomElement','Template.HelloWorld.html','Template.HTML.Element','Template.HTML.Input','Template.HTML.Script','Template.HTML.StyleSheet','Language.CSS','Language.SVG','Language.Racket','Language.OpenSCAD','Language.Rust','Language.PowerShell','Language.PowerShellData','Language.PowerShellXML','Template.PowerShell.RemoveParameter','Template.PowerShell.RenameVariable','Template.PowerShell.Attribute','Template.PowerShell.Help','Template.PowerShell.Parameter','Language.FSharp','Language.R','Language.Liquid','Language.Lua','Language.TypeScript','Template.HelloWorld.ts','Language.BrightScript','Language.C','Template.Include.c','Language.Haxe','Language.Vue','Language.Eiffel','Language.RSS','Language.GLSL','Language.XSL','Language.Python','Template.HelloWorld.py','Template.Import.py','Template.Assignment.py','Template.DoLoop.py','Template.ForeachArgument.py','Template.UntilLoop.py','Template.WhileLoop.py','Language.SQL','Language.Arduino','Language.GCode','Language.TOML','Language.Java','Language.XSD','Language.PipeScript','Template.PipeScript.ExplicitOutput','Template.PipeScript.Inherit','Template.PipeScript.OutputFile','Template.PipeScript.ProxyCommand','Template.PipeScript.Rest','Template.PipeScript.Dot','Template.PipeScript.DoubleDot','Template.PipeScript.DoubleEqualCompare','Template.PipeScript.NamespacedAlias','Template.PipeScript.NamespacedObject','Template.PipeScript.PipedAssignment','Template.PipeScript.SwitchAsIs','Template.PipeScript.TripleEqualCompare','Template.PipeScript.WhereMethod','Language.Scala','Language.Markdown','Language.Crystal','Template.HelloWorld.cr','Language.HCL','Language.ADA','Language.C3','Language.WebAssembly','Language.Kusto','Language.ObjectiveC','Language.BASIC','Language.PHP','Language.Wren','Template.HelloWorld.wren','Get-Transpiler','Start-PSNode','PipeScript.PostProcess.InitializeAutomaticVariables','PipeScript.PostProcess.PartialFunction','ConvertFrom-CliXml','ConvertTo-CliXml','Export-Json','Import-Json','Out-JSON','Out-HTML','Get-Interpreter','Invoke-Interpreter','Out-Parser','Parse.CSharp','Parse.PowerShell','PipeScript.Optimizer.ConsolidateAspects','Signal.Nothing','Signal.Out','Aspect.DynamicParameter','Aspect.ModuleExtensionType','Aspect.ModuleExtensionPattern','Aspect.ModuleExtensionCommand','Aspect.GroupObjectByTypeName','Aspect.GroupObjectByType','Import-ModuleMember','Compile.LanguageDefinition','Export-Pipescript','Get-PipeScript','Import-PipeScript','Invoke-PipeScript','Join-PipeScript','New-PipeScript','Search-PipeScript','Update-PipeScript','Use-PipeScript','PipeScript.Automatic.Variable.IsPipedTo','PipeScript.Automatic.Variable.IsPipedFrom','PipeScript.Automatic.Variable.MyCallstack','PipeScript.Automatic.Variable.MySelf','PipeScript.Automatic.Variable.MyParameters','PipeScript.Automatic.Variable.MyCaller','PipeScript.Automatic.Variable.MyCommandAst','Protocol.HTTP','Protocol.JSONSchema','Protocol.OpenAPI','Protocol.UDP','Route.Uptime','Route.VersionInfo'
    PrivateData = @{        
        FunctionTypes = @{
            'Partial' = @{
