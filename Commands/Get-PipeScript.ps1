function Get-PipeScript {
    ...
    [Parameter(ValueFromPipelineByPropertyName)]
    [ValidateSet('Analyzer','Aspect','AutomaticVariable','BuildScript','Compiler','Interface','Optimizer','Parser','Partial','PipeScriptNoun','PostProcessor','PreProcessor','Protocol','Sentence','Template','Transform','Transpiler')]
    [string[]]
    $PipeScriptType,
