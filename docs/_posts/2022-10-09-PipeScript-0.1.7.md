...
---
## 0.1.7:
* Added LATEX / TEX support (Fixes [#230](https://github.com/StartAutomating/PipeScript/issues/230))
* Adding LUA support (Fixes [#246](https://github.com/StartAutomating/PipeScript/issues/246))
* Fixing Core Transpiler Attribute Behavior (Fixes [#247](https://github.com/StartAutomating/PipeScript/issues/247))
---
