...
It lets you compile PowerShell and easily work with 62 other languages (and counting).
...
PipeScript can be used to template 62 languages, and implicitly interpert 16 languages.
...
PipeScript can work with 62 languages.
