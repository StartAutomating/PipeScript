...
It lets you compile PowerShell and easily work with 66 other languages (and counting).
...
PipeScript can be used to template 66 languages, and implicitly interpert 16 languages.
...
PipeScript can work with 66 languages.
